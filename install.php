        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            ...
            <tr>
             ...
             <td><?php echo '<img src="cat_images/'.$image.'" width=100 height=50'; ?></td>
             <td class="body-item mbr-fonts-style display-7"><?php echo $price; ?></td>
                <td class="body-item mbr-fonts-style display-7"><a href="edit_install.php?id=<?php echo $row_trans['id'];?>">Edit</a></td>
             <td class="body-item mbr-fonts-style display-7" style="background-color: red;"><a href="del_install.php?id=<?php echo $row_trans['id']; ?>">Del</a></td>
