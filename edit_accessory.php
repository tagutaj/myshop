      ...
      <div class="table-wrapper">
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            ...
            <th class="head-item mbr-fonts-style display-7">DEVICES</th>
            ...
            <?php
                ...
                $get_trans="SELECT * FROM accessories WHERE id=$key";
                $run_trans=mysqli_query($con,$get_trans);
                $i=0;
                while($row_trans=mysqli_fetch_array($run_trans)){
                              
            echo "<tr><form action=edit_accessory.php method='post'></tr>";
            echo"<td><input type=text name=category value='".$row_trans['category']."'></td>";
            echo"<td><input type=text name=device_name value='".$row_trans['device_name']."'></td>";
        ...
        $sql=" UPDATE accessories SET category='$_POST[category]',device_name='$_POST[device_name]',price='$_POST[price]' WHERE id='$_POST[id]'";
