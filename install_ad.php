      ...
      <div class="table-wrapper">
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            ...
            <div class="card p-3 col-2 col-md-4 col-lg-10">
                <div class="card-wrapper ">
                <div class="card-img">
                <div class="mbr-overlay"></div>
                <div class="mbr-section-btn text-center"><a href="insert_order.php?category=<?php echo $service; ?>" class="btn btn-primary display-4"><strong>Click here to Order!</strong></a></div>
...
<?php include("includes/footer.html"); ?>
 ...
 <div id="scrollToTop" class="scrollToTop mbr-arrow-up"><a style="text-align: center;"><i class="mbr-arrow-up-icon mbr-arrow-up-icon-cm cm-icon cm-icon-smallarrow-up"></i></a></div>
    <input name="animation" type="hidden"></html>