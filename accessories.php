        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            ...
            <tr>
             ...
             <td class="body-item mbr-fonts-style display-7"><?php echo '<img src="accessories_images/'.$image.'" width=100 height=50'; ?></td>
             ...
             <td class="body-item mbr-fonts-style display-7" style="background-color: yellow">
                 <a href="edit_accessory.php?id=<?php echo $row_trans['id']; ?>">Edit</a></td>
             <td class="body-item mbr-fonts-style display-7" style="background-color: red;"><a href="del_accessory.php?id=<?php echo $row_trans['id']; ?>">Del</a></td>
