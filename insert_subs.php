<?php
	...
	$sql="INSERT INTO  subscriptions(category,price,product_img)VALUES('$category','$price','$image')";
        ...
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2"><strong>
                    ADD DSTV SUBS PACKAGES
                </strong></h2>
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5"><strong><u>
                    NB</u>&nbsp;: <em>ZW ==&gt; Zimbabwe Accounts </em></strong><em><br><strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;SA ==&gt; South African Accounts</strong></em></h3>
            </div>
        </div>
    </div>
                ...
                <form action="" method="POST" enctype="multipart/form-data" class="mbr-form form-with-styler">
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-md-10  form-group" data-for="category">
                            ...
                            <option>ZW Lite</option>
                            <option>ZW Access</option>
                            <option>ZW Family</option>
                            <option>ZW Compact</option>
                            <option>ZW Compact Plus</option>
                            <option>ZW Premium</option>
                            <option>SA EasyView</option>
                            <option>SA Access</option>
                            <option>SA Family</option>
                            <option>SA Compact</option>
                            <option>SA Compact Plus</option>
                            <option>SA Premium</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="dragArea row">
                        <div class="col-md-2">
                        <label for="product_img-form1-1s" class="form-control-label mbr-fonts-style display-7">Category Image</label>
                        </div>
